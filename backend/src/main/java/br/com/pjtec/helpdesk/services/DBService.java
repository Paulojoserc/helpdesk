...
public class DBService {
	...
	public void instanciaDB() {
		Tecnico tec1 = new Tecnico(null, "Paulo Costa", "550.482.150-95", "paulocosta@mail.com", encoder.encode("123"));
		...
		Cliente cli1 = new Cliente(null, "Neymar Jr", "111.661.890-74", "einstein@mail.com", encoder.encode("123"));
